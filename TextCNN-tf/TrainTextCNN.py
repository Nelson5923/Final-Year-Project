...
tf.flags.DEFINE_integer("embedding_dim", 250, "Dimensionality of character embedding (default: 128)")
...
def train(x_train, y_train, x_dev, y_dev, embedding, vocab_processor):
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            # Restriction on Sentence Length through Vocab Processor
            ...
            def train_step(x_batch, y_batch, embedding):
                ...
                _, _, step, summaries, loss, accuracy, prediction = sess.run(
                    [cnn.embedding_init, train_op, global_step, train_summary_op, cnn.loss, cnn.accuracy, cnn.predictions],
                    feed_dict)
