...
class TextCNN(object):
    ...
    def __init__(self, sequence_length, num_classes, vocab_size,
                 embedding_size, filter_sizes, num_filters, l2_reg_lambda=0.01, pretrain_enable=True):
        ...
        with tf.name_scope("output"):
            ...
            self.predictions = tf.argmax(self.scores, 1, name="predictions") # MaxPool
